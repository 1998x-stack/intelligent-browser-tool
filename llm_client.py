...
class LLMClient:
    ...
    def check_connection(self) -> bool:
        ...
        try:
            ...
            logger.error(f"无法连接Ollama服务: {get_err_message()}")
            return False
    ...
    def list_models(self) -> List[str]:
        ...
        try:
            ...
            logger.error(f"获取模型列表失败: {get_err_message()}")
            return []
        ...
        **kwargs
        ...
        for attempt in range(self.config.max_retries):
            try:
                ...
                logger.warning(f"LLM请求失败 (尝试 {attempt + 1}/{self.config.max_retries}): {get_err_message()}")
    ...
    def generate_stream(
        ...
        **kwargs
        ...
        try:
            ...
            logger.error(f"流式生成失败: {get_err_message()}")
            yield f"[错误: {e}]"
    ...
    def chat(
        ...
        **kwargs
        ...
        try:
            ...
            logger.error(f"Chat请求失败: {get_err_message()}")
            return LLMResponse(
                content="",
                model=model,
                success=False,
                error=str(get_err_message())
            )
